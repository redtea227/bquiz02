<input type="button" class="myTab" value="健康新知" data-target="tab1">
<input type="button" class="myTab" value="菸害防治" data-target="tab2">
<input type="button" class="myTab" value="癌症防治" data-target="tab3">
<input type="button" class="myTab" value="慢性病防治" data-target="tab4">

<div>
  <div class="myTabDiv" data-name="tab1">
    <pre><h2>健康新知</h2>
...
7. 減少看電視、打電玩等靜態生活的時間。
  ...
  <div class="myTabDiv" data-name="tab2">
    <pre><h2>菸害防制</h2>
菸害防治法規
...
第三十三條　　本法所定罰則，除第二十五條規定由中央主管機關處罰外，由直轄市、縣（市）主管機關處罰之。</pre>
  ...
  <div class="myTabDiv" data-name="tab3">
    <pre><h2>癌症防治</h2>
降低罹癌風險 建構健康生活型態
...
上稿日期：2010/1/20</pre>
  ...
  <div class="myTabDiv" data-name="tab4">
    <pre><h2>慢性病防法</h2>
長期憋尿 泌尿系統問題多 
資料來源：中央健康保險局雙月刊第98期
上稿日期：2012/08/10
...
<script>
  $('.myTabDiv').hide();
  $('.myTabDiv[data-name="tab1"]').show();

  $('.myTab').click(function(){
    $('.myTabDiv').hide();
    $('.myTabDiv[data-name="'+$(this).attr('data-target')+'"]').show()
  })
</script>