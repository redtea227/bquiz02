...
INSERT INTO `news` (`id`, `title`, `news`, `type`, `pop`, `sh`) VALUES
...
INSERT INTO `que` (`id`, `text`, `total_vote`, `sh`) VALUES
(1, '你最常做什麼運動來促進健康體能呢?', 3, 1),
(2, '二手菸沒有安全劑量，只要有暴露，就會有危險，請問它會造成身體上哪些危害?', 2, 1);
...
INSERT INTO `que_backup` (`id`, `text`, `parent`, `vote`, `sh`) VALUES
(1, '你最常做什麼運動來促進健康體能呢?', 0, 2, 1),
(2, '健走或爬樓梯、慢跑等較不受時間、場地限制的運動。', 1, 0, 1),
(3, '仰臥起坐、抬腿及伏地挺身、伸展操、瑜珈等室內運動。', 1, 2, 1),
(4, '球類運動、游泳、跳舞、騎腳踏車等加強心肺功能的運動。', 1, 0, 1),
(5, '舉重鍛鍊、彈力帶、啞鈴等運用輔助器材鍛鍊肌耐力的運動。', 1, 0, 1),
(6, '二手菸沒有安全劑量，只要有暴露，就會有危險，請問它會造成身體上哪些危害?', 0, 3, 1),
(7, '增加罹患冠狀動脈心臟病及罹病死亡之風險。', 6, 1, 1),
(8, '孩子的的健康會產生許多影響，例如容易咳嗽或打噴嚏、罹患氣喘或讓症狀更嚴重、會因刺激耳咽管，感染中耳炎、肺功能較差、容易罹患呼吸道疾病等。', 6, 0, 1),
(9, '孕婦吸入二手菸易造成流產、早產、胎盤早期剝離、子宮感染等疾病。', 6, 0, 1),
(10, '長期的暴露會造成更嚴重的胸腔問題和過敏症，還會增加心臟病和肺癌的罹患率。', 6, 2, 1),
(11, '以上皆是。', 6, 0, 1);
...
INSERT INTO `vote` (`id`, `que_id`, `text`, `vote`) VALUES
(1, 1, '健走或爬樓梯、慢跑等較不受時間、場地限制的運動。', 1),
(2, 1, '仰臥起坐、抬腿及伏地挺身、伸展操、瑜珈等室內運動。', 0),
(3, 1, '球類運動、游泳、跳舞、騎腳踏車等加強心肺功能的運動。', 1),
(4, 1, '舉重鍛鍊、彈力帶、啞鈴等運用輔助器材鍛鍊肌耐力的運動。', 1),
(5, 2, '增加罹患冠狀動脈心臟病及罹病死亡之風險。', 0),
(6, 2, '孩子的的健康會產生許多影響，例如容易咳嗽或打噴嚏、罹患氣喘或讓症狀更嚴重、會因刺激耳咽管，感染中耳炎、肺功能較差、容易罹患呼吸道疾病等。', 0),
(7, 2, '孕婦吸入二手菸易造成流產、早產、胎盤早期剝離、子宮感染等疾病。', 0),
(8, 2, '長期的暴露會造成更嚴重的胸腔問題和過敏症，還會增加心臟病和肺癌的罹患率。', 1),
(9, 2, '以上皆是。', 1),
(12, 0, '', 1),
(13, 0, '', 1);
...
--
-- 使用資料表自動遞增(AUTO_INCREMENT) `que_backup`
--
ALTER TABLE `que_backup`
